...
const options = CONF.provider_options.polling_provider

class polling_provider extends Base_Stream_Provider{

    constructor(){
        super("POLLING");
        this.interval = options.poll_interval_ms;//ms
        this.cronjobs_data = [];
        this.max_job_mem_limit = 512// -1= unlimited;
        this.main();
    }
    async main() {
        // helper     
...
module.exports = polling_provider
